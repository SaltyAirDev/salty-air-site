...
export function ROISection({ content: roi = lawRoi }: { content?: RoiContent }) {
  return (
    <section className="w-full py-32 md:py-40 px-6 md:px-16 bg-primary text-background relative overflow-hidden">
      <div className="max-w-7xl mx-auto">
        <SectionFade>
          <div className="max-w-3xl mb-16 text-center mx-auto">
            ...
            <h2 className="text-4xl md:text-6xl font-heading font-bold tracking-tight mt-4 leading-[1.1]">
              <RichHeadline lines={roi.headlineRich} accentClass="text-accent" />
            </h2>
        ...
        <SectionFade delay={0.15}>
          <DashboardMockup metrics={roi.metrics} label={roi.dashboardLabel} />
        </SectionFade>
        ...
        <SectionFade delay={0.2}>
          ...
          <div className="mt-8 flex justify-center">
            ...
            >
              <span className="relative z-10 block transition-colors group-hover:text-white">{roi.ctaLabel}</span>
